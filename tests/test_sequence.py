...
class VideoSequenceTestcase(unittest.TestCase):
    ...
    def test_get_rel_position(self):
        ...
        self.assertEqual(vs.get_rel_position(0.4), 0.4)
        self.assertEqual(vs.get_rel_position(0.5), 0.5)
        self.assertEqual(vs.get_rel_position(0.6), 0.6)
        self.assertEqual(vs.get_rel_position(1), 1.0)
        vs = VideoSequence(5,5)
        self.assertEqual(vs.get_rel_position(0), 0.0)
        self.assertEqual(vs.get_rel_position(2.4), 0.48)
        self.assertEqual(vs.get_rel_position(2.5), 0.5)
        self.assertEqual(vs.get_rel_position(2.6), 0.52)
    ...
    def test_get_nearest_frame(self):
        ...
        self.assertEqual(vs.get_nearest_frame(0.5), 1-1)
        self.assertEqual(vs.get_nearest_frame(1), 1-1)
        vs = VideoSequence(1,3)
        self.assertEqual(vs.get_nearest_frame(0), 1-1)
        self.assertEqual(vs.get_nearest_frame(0.1), 1-1)
        self.assertEqual(vs.get_nearest_frame(0.4), 1-1)
        self.assertEqual(vs.get_nearest_frame(0.5), 2-1)
        self.assertEqual(vs.get_nearest_frame(0.55), 2-1)
        self.assertEqual(vs.get_nearest_frame(0.6), 2-1)
        self.assertEqual(vs.get_nearest_frame(0.9), 3-1)
        self.assertEqual(vs.get_nearest_frame(1), 3-1)
        vs = VideoSequence(1,10)
        self.assertEqual(vs.get_nearest_frame(0), 1-1)
        self.assertEqual(vs.get_nearest_frame(0.1), 1-1)
        self.assertEqual(vs.get_nearest_frame(0.4), 4-1)
        self.assertEqual(vs.get_nearest_frame(0.5), 5-1)
        self.assertEqual(vs.get_nearest_frame(0.55), 6-1)
        self.assertEqual(vs.get_nearest_frame(0.6), 6-1)
        self.assertEqual(vs.get_nearest_frame(0.9), 9-1)
        self.assertEqual(vs.get_nearest_frame(1), 10-1)
        vs = VideoSequence(5,5)
        self.assertEqual(vs.get_nearest_frame(2), 2-1)
        self.assertEqual(vs.get_nearest_frame(2.4), 2-1)
        self.assertEqual(vs.get_nearest_frame(2.5), 3-1)
        self.assertEqual(vs.get_nearest_frame(2.6), 3-1)

    def test_get_nearest_frame_min_max(self):
        vs = VideoSequence(1,1)
        self.assertEqual(vs.get_nearest_frame(0), 1-1)
        self.assertEqual(vs.get_nearest_frame(1.1), 1-1)
        vs = VideoSequence(1,3)
        self.assertEqual(vs.get_nearest_frame(0), 1-1)
        self.assertEqual(vs.get_nearest_frame(1.1), 3-1)
